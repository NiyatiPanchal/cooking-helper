...
function About() {
    ...
    <div className="container">
      <img src="https://images.unsplash.com/photo-1444011283387-7b0f76371f12?ixlib=rb-1.2.1&q=80&fm=jpg&crop=entropy&cs=tinysrgb&w=400&fit=max&ixid=eyJhcHBfaWQiOjE0NTg5fQ" alt="profile image" class="profile-img"></img>
      <h3 className="name">Falak Hirani</h3>
    ...
    <div className="container">
      ...
      <h3 className="name">Niyati Panchal</h3>
      <p className="description">Student</p>
    </div>
